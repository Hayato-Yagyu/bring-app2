...
const NewPost = () => {
  ...
  const handleApproval = () => {
    ...
    emailjs.send("service_0sslyge", "template_81c28kt", templateParams).then(() => {
      // do something
    });
  };
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <TextField
                ...
                value={applicantdate}
                onChange={(e) => {
                  setApplicantdate(e.target.value);
                }}
              />
              <br />
              <br />
              ...
              <br />
              {selectedOption === "その他" && <TextField label="Other" value={otherInput} onChange={handleOtherInputChange} fullWidth sx={{ width: 400 }} />}
              ...
              <Button onClick={handleReset} variant="outlined" sx={{ width: 150 }}>
                キャンセル
              </Button>
